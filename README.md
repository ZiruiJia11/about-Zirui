...
This site is deployed with GitHub Pages from the repository root. After building, the generated `dist/index.html` and `dist/assets` are copied back to the root so GitHub Pages can serve the latest static version.

Important files:

- `src/App.jsx` - main React content and portfolio data
